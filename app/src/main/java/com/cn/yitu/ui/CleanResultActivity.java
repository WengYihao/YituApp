...
public class CleanResultActivity extends AppCompatActivity implements LocationSource,AMapLocationListener,View.OnClickListener{
    ...
    private TextView back,staff_name,staff_phone,onBind,upLoad;
    ...
    public void activate(OnLocationChangedListener onLocationChangedListener) {
        ...
        if (mlocationClient == null){
            mlocationClient = new AMapLocationClient(CleanResultActivity.this);
