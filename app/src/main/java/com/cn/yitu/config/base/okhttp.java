...
public class okhttp {
    ...
    // 上传图片公有方法
    public final static void uploadImgAndParameter(Map<String, Object> map,String url,final CallBack callBack) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response)
                ...
                Log.i("123", "上传照片成功-->" + data);
                call.cancel();// 上传成功取消请求释放内存
            }

            @Override
            public void onFailure(Call call, final IOException e) {
                Log.i("123", "上传失败-->" + e.getMessage());
